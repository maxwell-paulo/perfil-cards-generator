            ...
            <div className="w-full max-w-sm">
                ...
                >
                    <div className="text-center">
                        <h1 className="text-title text-2xl font-bold mb-2">Fazer Login</h1>
                        <p className="text-subtitle text-sm">Entre com suas credenciais</p>
                    </div>
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full bg-accent text-white py-3 px-4 rounded-md hover:opacity-90 transition-opacity disabled:opacity-50"
                    >
